...
def comparison_list_size(list_data_a, list_data_b):
    ...
    result = list_data_a if (
        len(list_data_a) >= len(list_data_b)) else list_data_b
...
def discount_price(price):
    ...
    result = price * 0.9 if price < 100000 else price * 0.8
...
def binary_converter(decimal_number):
    ...
    result = '{0:b}'.format(decimal_number)
...
def number_of_cases(list_data):
    ...
    result = sorted(set([str(a)+str(b) for a in list_data for b in list_data]))
...
def main():
    ...
    print(find_smallest_value([-11, 2, 3, 4, 5]))

    print(sum_of_list([1, 2, 3]))
    print(sum_of_list([1, 1, 0]))

    print(comparison_list_size([1, 2, 3], [4, 5, 6, 1]))
    print(comparison_list_size([1, 2, 3], [0]))

    print(odd_even_check(1, 2))
    print(odd_even_check(2, 2))
