...
def is_help_command(user_input):
    ...
    result = user_input.lower() == "h" or user_input.lower() == "help"
...
def is_validated_english_sentence(user_input):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당 또는 필요에 따라 자유로운 수정
    result = ("".join(c for c in user_input if c not in '.,!? ')).isalpha()
...
def is_validated_morse_code(user_input):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당 또는 필요에 따라 자유로운 수정
    morse_dic = get_morse_code_dict()
    result = True
    for input in user_input.strip().split(" "):
        if not input:
            continue
        try:
            list(morse_dic.keys())[
                list(morse_dic.values()).index(input.strip())]
        except:
            result = False
            break
...
def get_cleaned_english_sentence(raw_english_sentence):
    ...
    result = "".join(c for c in raw_english_sentence.strip()
                     if c not in ".,!?")
...
def decoding_character(morse_character):
    ...
    result = list(morse_code_dict.keys())[
        list(morse_code_dict.values()).index(morse_character.strip())]
...
def decoding_sentence(morse_sentence):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당 또는 필요에 따라 자유로운 수정
    result = " ".join("".join(decoding_character(character) for character in sentence.strip().split(" "))
                      for sentence in morse_sentence.strip().split("  ") if sentence)
...
def encoding_sentence(english_sentence):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당 또는 필요에 따라 자유로운 수정
    result = "  ".join(" ".join(encoding_character(character) for character in sentence) for sentence in (get_cleaned_english_sentence(
        english_sentence).upper()).split(" ") if sentence)
